...
public class FuncionarioServiceTest {
    ...
    void FuncionarioPadrao_ValidaFuncionarioAutorizadoTest() {
        ...
        boolean funcionarioAutorizado = this._serviceFuncionario.validaFuncionarioPadraoAutorizado(nome, acesso);
    ...
    @Test
    void FuncionarioExistenteEPadrao_ValidaFuncionarioAutorizadoTest() throws AutorizationInitialException {
    ...
    @Test
    void FuncionarioExistente_ValidaFuncionarioAutorizadoTest() throws AutorizationInitialException {
        ...
        boolean funcionarioAutorizado = this._serviceFuncionario.validaFuncionarioAutorizado(funcionario.getId(),
    ...
    @Test
    void FuncionarioExistenteRhInvalid_ValidaFuncionarioAutorizadoTest() throws AutorizationInitialException {
    ...
    @Test
    void FuncionarioExistenteNaoValido_ValidaFuncionarioAutorizadoTest() throws AutorizationInitialException {
        this._serviceFuncionario.save(funcionario);
        if (!this._serviceFuncionario.isExistRh()) {
            assertTrue(true);
            return;
    ...
    @Test
    void FuncionarioExistenteInvalid_ValidaFuncionarioAutorizadoTest() throws AutorizationInitialException {
